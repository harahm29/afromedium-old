...
var RubikControls = function(game) {
    ...
    const helperMaterial = new BABYLON.MeshBasicMaterial({ depthWrite: false, transparent: true, opacity: 0, color: 0x0033ff });
    ...
    this.helper = new BABYLON.Mesh(
        new BABYLON.PlaneBufferGeometry(200, 200),
