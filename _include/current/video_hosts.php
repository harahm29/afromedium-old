    ...
    static protected function _filterFromDbYoutube($text, $pretag, $posttag, $w)
    {
        ...
        foreach ($objs as $obj) {
            ...
            if(self::getMobile()) {
                ...
                $html = '<a target="_blank" class="one_media_youtube_img" href="http://www.youtube.com/watch?v=' . $obj . '"><img ' . $style . ' src="' . self::_filterOneImageBigFromDbYoutube($obj, 1, 'mq') . '"></a>' . $htmlUrl;
            }
            $tag = '{youtube:' . $objOrig . '}';
