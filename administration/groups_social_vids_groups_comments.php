...
class CPage extends CHtmlBlock
{
	function parseBlock(&$html)
	{
        ...
        $pagerOnPage = 20;
        $pagerUrl = g('path','url_administration') . 'groups_social_vids_groups_comments.php?id=' . $pid . '&p=%s';
...
$page = new CPage("main", $g['tmpl']['dir_tmpl_administration'] . "groups_social_vids_groups_comments.html");
